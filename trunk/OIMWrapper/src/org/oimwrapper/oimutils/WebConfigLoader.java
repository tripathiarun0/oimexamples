...
public class WebConfigLoader {
    ...
    public boolean getConfig(String fileName) throws OIMHelperException {
        ...
        String home = System.getProperty("aihome");
        if (StringUtils.isEmpty(home))
        {
            throw new OIMHelperException("Error: aihome System Property is Missing");
        }
        ...
        try
        {
            ...
            configStream = new ByteArrayInputStream(getBytesFromFile(propertiesPath));
        }
        catch(IOException e)
        {
