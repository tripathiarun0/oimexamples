...
set CLASSPATH=%CLASSPATH%;C:\javalibs\OIM11GClient\lib\spring.jar;C:\javalibs\OIM11GClient\lib\commons-logging.jar;C:\javalibs\OIM11Gext\csv.jar
...
java  %SYSOPTS% -cp %CLASSPATH% org.oim.jmsprovision.RoleRecon